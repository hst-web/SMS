...
function creatIframe(href, titleName) {
        ...
        $("#min_title_list li").contextMenu('Huiadminmenu', {
            bindings: {
                ...
                'refreshthis': function (t) {
                    ...
                    var aCloseIndex = $(t).find("span").parents("li").index();
                    $('#iframe_box').find('.show_iframe').eq(aCloseIndex).find("iframe").attr("src", thishref);
                }
            }
        });
    } else {
    ...
    iframeBox.hide();
    iframe_box.append('<div class="show_iframe"><div class="spinner"> <div class="bounce1"></div> <div class="bounce2"></div> <div class="bounce3"></div></div><iframe frameborder="0" src=' + href + '></iframe></div>');
    var showBox = iframe_box.find('.show_iframe:visible');
    showBox.find('iframe').load(function () {
        showBox.find('.spinner').hide();
    });
}
