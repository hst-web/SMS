...
namespace ASP
{
    ...
    #line 6 "..\..\Areas\manage\Views\MessageRecord\Add.cshtml"
    using ZT.SMS.Core;
    
    #line default
    #line hidden
    
    #line 5 "..\..\Areas\manage\Views\MessageRecord\Add.cshtml"
    using ZT.SMS.Web;
    
    #line default
    #line hidden
    
    #line 7 "..\..\Areas\manage\Views\MessageRecord\Add.cshtml"
    using ZT.Utillity;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/manage/Views/MessageRecord/Add.cshtml")]
    public partial class _Areas_manage_Views_MessageRecord_Add_cshtml : System.Web.Mvc.WebViewPage<MsgViewModel>
    {
        public _Areas_manage_Views_MessageRecord_Add_cshtml()
        {
        }
...
WriteLiteral(">\r\n");
            ...
            #line 20 "..\..\Areas\manage\Views\MessageRecord\Add.cshtml"
     using (Ajax.BeginForm("Add", "MessageRecord", new { }, new AjaxOptions() { HttpMethod = "Post", OnSuccess = "formSuccess(data)", OnBegin = "disSubmit('sub_btn')", OnComplete = "enSubmit('sub_btn')" }, new { id = "", @class = "form form-horizontal" }))
    {
