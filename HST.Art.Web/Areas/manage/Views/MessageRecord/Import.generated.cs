...
namespace ASP
{
    ...
    #line 6 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
    using ZT.SMS.Core;
    
    #line default
    #line hidden
    
    #line 5 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
    using ZT.SMS.Web;
    
    #line default
    #line hidden
    
    #line 7 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
    using ZT.Utillity;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Areas/manage/Views/MessageRecord/Import.cshtml")]
    public partial class _Areas_manage_Views_MessageRecord_Import_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Areas_manage_Views_MessageRecord_Import_cshtml()
        {
        }
        public override void Execute()
        {
            
            #line 1 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
...
WriteLiteral("\r\n");
            ...
            #line 9 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
...
WriteLiteral("\r\n");
            ...
            #line 10 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
...
WriteAttribute("src", Tuple.Create(" src=\"", 160), Tuple.Create("\"", 216)
, Tuple.Create(Tuple.Create("", 166), Tuple.Create<System.Object, System.Int32>(Href("~/Content/lib/webuploader/0.1.5/webuploader.min.js")
, 166), false)
);
...
WriteAttribute("href", Tuple.Create(" href=\"", 935), Tuple.Create("\"", 963)
, Tuple.Create(Tuple.Create("", 942), Tuple.Create<System.Object, System.Int32>(Href("~/Content/信息导入模板.xlsx")
, 942), false)
);
...
WriteLiteral(">未发送</b> 状态</li>\r\n                <li>3、一次导入数据建议在500条以内,导入文件为 xlsx 或 xls 格式</li>\r" +
"\n                <li>4、请不要重复导入有相同 <b");

WriteLiteral(" style=\"color:red\"");

WriteLiteral(">订单号</b> 的数据</li>\r\n                <li>5、如遇到导入失败可通过下载失败数据进行核对</li>\r\n            <" +
"/ul>\r\n        </div>\r\n        <div");
...
WriteLiteral(@">
    ...
    uploader;
        uploader = WebUploader.create({
            ...
            #line 98 "..\..\Areas\manage\Views\MessageRecord\Import.cshtml"
...
"iple: false },\r\n            //选择文件自动上传\r\n            auto: true,\r\n            acc" +
"ept: { title: \"只能上传xlsx,xls文件\", extensions: \'xlsx,xls\', mimeTypes: \'application/" +
